...
function devolverPrimerElemento(array) {
   ...
   // Tu código:var primerElemento = array.shift();
...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var incrementar = array.map((num) => {return num +1})
...
function todosIguales(array) {
   ...
   // Tu código:
   var iguales = array.every(function(elemento) {
...
function continueStatement(num) {
   ...
   for (let i = 0; i < 10; i++) {
     ...
     arrayAumentaDos.push(num); // Add the new value to the array
   }
 
   return arrayAumentaDos; // Return the array containing the values
